/**
 * @license AngularJS v1.3.9-local+sha.35aec52
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.9-local+sha.35aec52/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.9-local+sha.35aec52',    // all of these placeholder strings will be replaced by grunt's
